...
<figure class="flag-card primary">
    <img src="/assets/img/flags/us-flag-50.png" 
...
<figure class="flag-card">
    <img src="/assets/img/flags/pow-mia.png" 
...
```html
<figure class="flag-card">
    <img src="/assets/img/flags/gadsden.png" 
...
```html
<figure class="flag-card">
    <img src="/assets/img/flags/appeal-to-heaven.png" 
...
```html
<figure class="flag-card">
    <img src="/assets/img/flags/gonzales-come-and-take-it.png" 
...
```html
<figure class="flag-card">
    <img src="/assets/img/flags/betsy-ross-13-star.png" 
...
```html
<p><small>All flag images displayed are from verified public domain sources 
or official U.S. Government documentation. See sources above for 
verification and licensing information.</small></p>
```

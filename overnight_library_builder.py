...
class OvernightLibraryBuilder:
    ...
    def build_library(self, practice_areas: List[str] = None, 
            ...
            try:
                ...
                if doc:
                    ...
                    self.stats['errors'].append({
                        'citation': citation,
                        'reason': 'Not found on CourtListener'
                    })
    ...
    def _generate_report(self):
        ...
        success_rate = (self.stats['imported'] / self.stats['total_attempted'] * 100) \
        ...
        if self.stats['errors']:
            ...
            for error in self.stats['errors']:
                logger.info(f"  - {error.get('citation', 'Unknown')}: {error.get('reason', error.get('error'))}")
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help='Maximum number of cases to import'
    )
    parser.add_argument(
        '--rate-limit',
        type=int,
